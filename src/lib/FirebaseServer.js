 ...
 * # Firebase.js
 *
 * This class interfaces with Firebase.com using the rest api
 *
...
class FirebaseServer extends Backend {
  /**
   * ## Hapi.js client
   *
   *
  ...
  initialize () {
    ...
    console.log(this, 'this is confirg')
  }
  /**
   * ### signup
   *
...
export let firebaseServer = new FirebaseServer()
