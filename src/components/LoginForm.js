...
export default class LoginForm extends Component {
  ...
  render () {
    ...
    let username = {
      label: 'username',//I18n.t('LoginForm.username'),
    ...
    let email = {
      label: 'email',//I18n.t('LoginForm.email'),
    ...
    let passwordAgain = {
      label: 'password again',//I18n.t('LoginForm.password_again'),
      secureTextEntry: secureTextEntry,
      maxLength: 12,
      editable: !this.props.form.isFetching,
    ...
    switch (formType) {
      ...
      case (REGISTER):
        ...
        options.fields['username'].placeholder = 'username'//I18n.t('LoginForm.username')
        options.fields['username'].autoCapitalize = 'none'
        options.fields['email'] = email
        options.fields['email'].placeholder = 'email'//I18n.t('LoginForm.email')
        options.fields['email'].autoCapitalize = 'none'
        options.fields['password'] = password
        options.fields['password'].placeholder = 'password'//I18n.t('LoginForm.password')
        options.fields['passwordAgain'] = passwordAgain
        options.fields['passwordAgain'].placeholder = 'password again'// I18n.t('LoginForm.password_again')
        break
