...
export default function globalReducer (state = initialState, action) {
  ...
  switch (action.type) {
    ...
    console.log('SESSION_TOKEN_SUCCESS',action.payload.sessionToken);
     ...
     */
    case SET_STORE:
     console.log('SET_STORE',action.payload);
...
console.log('GET_STATE',_state);
     ...
     */
    case SET_STATE:
    console.log('GET_STATE',action.payload);
